...
const SistemasInternos = () => {
  const { user, isAuthorized, signOut, loading } = useAuth();
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <p className="text-gray-600 mb-4">
            Você está autenticado e autorizado a acessar esta área restrita.
          </p>
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <p className="text-sm text-green-800">
              ✓ Acesso autorizado para: <strong>{user.email}</strong>
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <p className="text-sm text-gray-600">
              Acesse e gerencie documentos internos da empresa.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <p className="text-sm text-gray-600">
              Visualize relatórios e análises de dados.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <p className="text-sm text-gray-600">
              Ajuste configurações e preferências do sistema.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <p className="text-sm text-gray-600">
              Visualize alertas e notificações importantes.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <p className="text-sm text-gray-600">
              Gerencie compromissos e eventos da empresa.
            </p>
          </div>
        </div>
      </main>
