    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Card: Calculadora SMT */}
          <a
            href="https://total.administradoramutual.com.br"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6 border-t-4 border-indigo-600"
          >
            <div className="flex items-center mb-4">
              ...
              <h2 className="ml-3 text-xl font-semibold text-gray-900">Calculadora SMT</h2>
            </div>
            <p className="text-gray-600 text-sm">
              Calculadora de Indenização SMT - Socorro Mútuo Total do Movimento Mais Brasil.
            </p>
          </a>
